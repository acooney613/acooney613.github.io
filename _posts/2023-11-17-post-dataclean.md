...
To collect this data, I created 5 different classes to create the 5 different datsets that I hoped to combine. I scraped and gathered <li class="masthead__menu-item">
