...
## Why R, Python, and Julia?

Write about the benefits and uses of the different programming languages, and the brief potential history
...
Add portion to read in data, perform the regression

Talk about different package options

show results

compare the results to the other programming languages at the end of the blog post 
```
