...
Is fan attendance the only metric for postseason success? To answer this question, I looked at the relationship between postseason success and team payroll. Looking at the plot below, we can see that on average, the teams that missed the postseason spent far less on players than the teams that made the playoffs. 

<div align = 'center'>
<img src = '/assets/images/barchart.png'>
</div>

The bar for World Series won once again contains one of the higher values while the smallest bar belongs to teams that missed the postseason. This is fairly consistent with the relationship found in the heatmap, as both show a positive correlation between payroll and postseason success.  
...
Looking next at a scatterplot for log of team payroll and proportion of stadium filled colored by whether or not a team made the postseason we can see that there is a fairly positive trend for both teams that made the postseason and teams that did not.

<div align = 'center'>
<img src = '/assets/images/postseason.png'>
</div>

The plot shows that, on average, teams that made the postseason tended to have higher stadium attendance for the same payroll value compared to teams that did not make the postseason. This is consistent with findings in the heatmap, as both show that there was a positive correlation between payroll and fan attendance.
